...
#Load the files
with open('best_fnb_svr_model.pkl','rb') as file_1:
    fnb_model = pickle.load(file_1)
...
def run():
    ...
    with st.form(key='form parameters'):
        emiten_code = st.text_input('Emiten Code', 'UNVR')
        ...
        political_stability = st.number_input('Political Stability', min_value = 0.0, max_value = 100.0, value=17.1)
